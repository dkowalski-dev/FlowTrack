...
class UserSettings(models.Model):
    ...
    offers_paginator = models.IntegerField(
        default=10, validators=[MinValueValidator(1), MaxValueValidator(100)]
    )
    produtcs_paginator = models.IntegerField(
        default=10, validators=[MinValueValidator(1), MaxValueValidator(100)]
    )
    categories_paginator = models.IntegerField(
        default=10, validators=[MinValueValidator(1), MaxValueValidator(100)]
    )
    statuses_paginator = models.IntegerField(
        default=10, validators=[MinValueValidator(1), MaxValueValidator(100)]
    )
    clients_paginator = models.IntegerField(
        default=10, validators=[MinValueValidator(1), MaxValueValidator(100)]
    )
    ...
    offers_sort = models.CharField(
        max_length=20, choices=offers_choices, default="-created"
    )
    products_sort = models.CharField(
        max_length=20, choices=products_choices, default="name"
    )
    categories_sort = models.CharField(
        max_length=20, choices=categories_choices, default="name"
    )
    statuses_sort = models.CharField(
        max_length=20, choices=statuses_choices, default="name"
    )
    individual_client_sort = models.CharField(
        max_length=20, choices=individual_client_choices, default="name"
    )
    company_client_sort = models.CharField(
        max_length=20, choices=company_client_choices, default="company_name"
    )
