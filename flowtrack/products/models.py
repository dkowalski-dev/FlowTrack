...
class Category(models.Model):
    ...
    vat = models.CharField(max_length=2, choices=choices, default='23') # Tutaj jeszcze wróć i się zastanów czy nie zmienić tego na intiger w razie operacji w przyszłości
